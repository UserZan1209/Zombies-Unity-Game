...
namespace InfimaGames.LowPolyShooterPack
{
    public class Inventory : InventoryBehaviour
    {
        ...
        /// </summary>
        [SerializeField] public WeaponBehaviour[] weapons;
        ...
        {
            weapons = new WeaponBehaviour[equippedAtStart];
...
/*            else
            {
                if (weapons[0] && weapons[1] == null)
                {
                    WeaponBehaviour w = weapons[0];

                    weapons = new WeaponBehaviour[weapons.Length+1];
                    weapons = GetComponentsInChildren<WeaponBehaviour>(true);
                    equipped = weapons[1];
            ...
            Debug.Log("Weapons " + weapons.Length.ToString());
